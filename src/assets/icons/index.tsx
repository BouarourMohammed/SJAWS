...
export const HomeIcon: React.FC<SvgProps> = (props: SvgProps) => (
  <Svg
    fill="white"
    strokeWidth={0}
...
export const PlanIcon: React.FC<SvgProps> = (props: SvgProps) => (
  <Svg
    fill="white"
    strokeWidth={0}
    viewBox="0 0 1024 1024"
...
export const MapIcon: React.FC<SvgProps> = (props: SvgProps) => (
  <Svg
    stroke="currentColor"
    fill="white"
    strokeWidth={0}
...
const LogoutIcon: React.FC<SvgProps> = (props: SvgProps) => (
  <Svg
    stroke="currentColor"
    fill="white"
    strokeWidth={0}
...
export const DeleteIcon: React.FC<SvgProps> = (props: SvgProps) => (
  <Svg
    stroke="currentColor"
    fill="currentColor"
    strokeWidth={0}
...
export const EditIcon: React.FC<SvgProps> = (props: SvgProps) => (
  <Svg
    stroke="currentColor"
    fill="currentColor"
    strokeWidth={0}
...
export const AlertsIcon: React.FC<SvgProps> = (props) => (
  <Svg
    stroke="currentColor"
    fill={COLORS.white}
    strokeWidth={0}
...
export const SignOutIcon: React.FC<SvgProps> = (props) => (
  <Svg
    stroke="currentColor"
    fill={COLORS.white}
    strokeWidth={0}
...
export const SubscriptionIcon: React.FC<SvgProps> = (props) => (
  <Svg
    stroke="currentColor"
    fill={COLORS.black}
    strokeWidth={0}
